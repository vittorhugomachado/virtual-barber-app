...
export function StepBarberTime({
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <div className="flex items-center justify-end gap-1.5 rounded-xl border border-neutral-200 bg-neutral-100 px-3.5 py-2.5 text-sm dark:border-neutral-800 dark:bg-neutral-900">
