...
export function Services({ services, isPreview, primaryColor }: ServicesProps) {
            ...
            return (
              ...
              >
                ...
                >
                  {inCart ? (
                    <>
                      <Check size={14} className="md:mr-1" /><span className="hidden md:block"> Adicionado</span>
                    </>
                  ) : (
                    <>
                      <Plus size={14} className="md:mr-1" /><span className="hidden md:block"> Adicionado</span>
                    </>
                  )}
                </Button>
              </div>
