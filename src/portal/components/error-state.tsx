...
//       }`}
//     >
//       <div className="flex max-w-2xl flex-col items-center rounded-2xl border border-current/15 bg-current/5 px-8 py-10">
//         <img
//           src={isDark ? "/image-error-dark.png" : "/image-error-light.png"}
//           alt="imagem de erro"
//           width={70}
//         />
//         <h2 className="mt-4 text-2xl font-semibold">Algo deu errado</h2>
